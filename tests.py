...
class TestLight(unittest.TestCase):
    ...
    def test_connect(self, mock_connect, mock_read, mock_send):
        ...
        self.assertEqual(
            light.__str__(),
            "ON  [Color: (103, 255, 104) Brightness: 255 raw state: 129,69,35,97,33,16,103,255,104,0,4,0,240,60,]",
        )
    ...
    def test_rgb(self, mock_connect, mock_read, mock_send):
        ...
        self.assertEqual(
            mock_send.call_args, mock.call(bytearray(b"1\x01\x19P\x00\xf0\x0f"))
        )
    ...
    def test_off_on(self, mock_connect, mock_read, mock_send):
        ...
        self.assertEqual(
            light.__str__(),
            "ON  [Warm White: 65% raw state: 129,69,35,97,33,16,0,0,0,166,4,0,15,51,]",
        )
        self.assertEqual(light.protocol, None)
        self.assertEqual(light.is_on, True)
    ...
    def test_ww(self, mock_connect, mock_read, mock_send):
        ...
        self.assertEqual(
            light.__str__(),
            "ON  [Color: (182, 0, 152) Brightness: 182 raw state: 129,69,35,97,33,16,182,0,152,0,4,0,240,188,]",
        )
        self.assertEqual(light.protocol, None)
        self.assertEqual(light.is_on, True)
        self.assertEqual(light.mode, "color")
        ...
        self.assertEqual(
            light.__str__(),
            "ON  [Warm White: 9% raw state: 129,69,35,97,33,16,0,0,0,25,4,0,15,166,]",
        )
        self.assertEqual(light.protocol, None)
        self.assertEqual(light.is_on, True)
        self.assertEqual(light.mode, "ww")
    ...
    def test_rgb_brightness(self, mock_connect, mock_read, mock_send):
        ...
        def read_data(expected):
            ...
            if calls == 3:  # turn on response
                self.assertEqual(expected, 4)
                return bytearray(b"\x0fq#\xa3")
            if calls == 4:  # state update sent after turn on response
                self.assertEqual(expected, 14)
        ...
        self.assertEqual(
            light.__str__(),
            "OFF  [Color: (255, 91, 212) Brightness: 255 raw state: 129,69,36,97,33,16,255,91,212,0,4,0,240,157,]",
        )
        self.assertEqual(light.protocol, None)
        self.assertEqual(light.is_on, False)
        self.assertEqual(light.mode, "color")
        ...
        self.assertEqual(
            light.__str__(),
            "ON  [Color: (255, 91, 212) Brightness: 255 raw state: 129,69,35,97,33,16,255,91,212,0,4,0,240,157,]",
        )
        self.assertEqual(light.protocol, None)
        self.assertEqual(light.is_on, True)
        self.assertEqual(light.mode, "color")
        ...
        self.assertEqual(mock_send.call_count, 3)
        self.assertEqual(
            mock_send.call_args, mock.call(bytearray(b"1\x03M\xf7\x00\xf0\x0f"))
        )
        self.assertEqual(
            light.__str__(),
            "ON  [Color: (255, 91, 212) Brightness: 255 raw state: 129,69,35,97,33,16,255,91,212,0,4,0,240,157,]",
        ...
        self.assertEqual(
            light.__str__(),
            "ON  [Color: (3, 77, 247) Brightness: 247 raw state: 129,69,35,97,33,16,3,77,247,0,4,0,240,181,]",
        )
        self.assertEqual(light.protocol, None)
        self.assertEqual(light.is_on, True)
        self.assertEqual(light.mode, "color")
    ...
    def test_rgbwwcw(self, mock_connect, mock_read, mock_send):
        ...
        def read_data(expected):
            ...
            if calls == 3:
                self.assertEqual(expected, 14)
                return bytearray(
                    b"\x81\x25\x23\x61\x21\x10\xb6\x00\x98\x19\x04\x25\x0f\xa6"
                )
        ...
        self.assertEqual(
            light.__str__(),
            "ON  [Color: (182, 0, 152) White: 0 raw state: 129,37,35,97,33,16,182,0,152,0,4,0,240,188,]",
        )
        ...
        self.assertEqual(
            light.__str__(),
            "ON  [Color: (182, 0, 152) White: 25 raw state: 129,37,35,97,33,16,182,0,152,25,4,37,15,166,]",
        )
